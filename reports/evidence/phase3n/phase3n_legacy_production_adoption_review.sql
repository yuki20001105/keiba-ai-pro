...
-- execution target scope review
-- execution target project ref not-bound
SET LOCAL lock_timeout = '5s';
SET LOCAL statement_timeout = '300s';
SET LOCAL idle_in_transaction_session_timeout = '300s';
SELECT pg_catalog.pg_advisory_xact_lock(pg_catalog.hashtextextended('phase3n-legacy-adoption:4670ee1c174ef3092e7a32c192a9fccc8711982532252576b214c6569fbf3083', 0));
