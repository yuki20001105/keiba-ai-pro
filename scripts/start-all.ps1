...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$workspaceRoot\python-api'; .\.venv\Scripts\python.exe main.py" -WindowStyle Normal
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$workspaceRoot'; npm run dev" -WindowStyle Normal
