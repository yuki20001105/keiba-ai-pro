...
ALLOWLIST_EXACT: Dict[str, str] = {
    ...
    "python-api/tests/test_phase3m_supabase_bootstrap_gate.py:assert len(manifest.migrations) == 11": "replaced by exact 14-migration assertion after adding guarded model approval, job, and worker-lease ledgers",
