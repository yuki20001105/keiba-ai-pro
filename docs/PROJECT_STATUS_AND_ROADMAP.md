...
| Python tests | Full `python-api/tests` suite passes 984 tests on exact commit `03e4963`; the model builder/verifier slice passes 72 tests and feature consistency passes 73 | Locally verified on Python 3.11.9; remote exact-SHA CI remains pending |
