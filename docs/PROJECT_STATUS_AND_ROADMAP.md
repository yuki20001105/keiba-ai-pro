...
| Frontend tests | 30 test files and 322 tests passed | Verified |
...
| Python tests | Full `python-api/tests` suite passes 980 tests; the model builder/verifier slice passes 72 tests and the leakage-sensitive feature-consistency slice passes 73 tests | Locally verified on Python 3.11.9; exact-SHA CI remains pending |
