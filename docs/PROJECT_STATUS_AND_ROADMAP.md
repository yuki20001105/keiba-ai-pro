...
| Ten-year speed-deviation candidate | A non-activating LightGBM regression candidate now predicts realized speed deviation directly. Its baseline is fitted on 2016-01-01 through 2026-02-01 training outcomes only (267,700 entries, 23,495 races), then applied unchanged to the 2026-02-02 through 2026-07-11 OOT window. Current-race `time_index`, lap chart, and derived pace fields were found to be post-race leakage and are now release-blocked. The leakage-free candidate improves winner AUC to 0.7802, with Brier 0.0791, ECE 0.0420, Spearman 0.7990, and RMSE 0.6947, but ROI -14.81% and maximum drawdown 21.42% still fail | Do not activate or deploy this candidate. Restore continuous 2019-2024 coverage, retain recency weighting, rerun forward-chaining model selection, and reserve data after the last inspected result for final holdout/prospective evidence |
...
| ML and business-value proof | 25% | 55% | 13.8% | The leakage-free ten-year speed-deviation candidate improves provisional OOT winner AUC from 0.7158 to 0.7802 and passes Brier/ECE/sample/bet/baseline-delta checks, but still fails AUC, ROI (-14.81% vs +3%), and maximum drawdown (21.42% vs 20%); the old AUC 0.8865 is not current-artifact proof |
