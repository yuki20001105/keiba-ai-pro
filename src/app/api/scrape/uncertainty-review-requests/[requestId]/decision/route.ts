...
export async function POST(
  ...
  const parsed = validateDecisionBody(bounded.value)
  ...
  const result = await transitionReviewViaRpc(serviceClient, actor.value, requestId.value, parsed.value)
