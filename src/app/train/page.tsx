      ...
      <main className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        <div className="bg-[#111] border border-[#1e1e1e] rounded-lg p-6 space-y-5">
          ...
          <div className="border border-[#1e1e1e] rounded-lg overflow-hidden">
            ...
            >
              <span className="text-xs text-[#555]">詳細設定</span>
        ...
        <div className="py-3 flex justify-end">
          <Link href="/predict-batch" className="shrink-0 flex items-center gap-1.5 text-[#555] hover:text-white text-xs transition-colors">
            予測実行へ
            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
